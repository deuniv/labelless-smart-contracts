...
contract Labelless {
    ...
    function distributeAwards(uint256 taskId) public {
        ...
        _taskDetails[taskId].labellerUsdValue = _taskDetails[taskId].UsdAmount * (100 - aFeePerc)/ 100 / 3; 
        _taskDetails[taskId].labellerLltValue = _taskDetails[taskId].labellerUsdValue; 

        _taskDetails[taskId].verifierUsdValue = _taskDetails[taskId].UsdAmount * (100 - aFeePerc)/ 100 / 3; 
        _taskDetails[taskId].verifierLltValue = _taskDetails[taskId].verifierUsdValue; 

        _taskDetails[taskId].innovatorUsdValue = _taskDetails[taskId].UsdAmount * (100 - aFeePerc)/ 100 / 3; 
        _taskDetails[taskId].innovatorLltValue = _taskDetails[taskId].innovatorUsdValue; 

        
        uint256 aFee = _taskDetails[taskId].UsdAmount * aFeePerc / 100;
        uint256 bFee = aFee * 20 / 100; 
        uint256 cFee = aFee * 30 / 100; 
        uint256 dFee = aFee * 50 / 100; 
        require((bFee + cFee + dFee) == aFee); 
